...
kubectl create secret generic teste-groffe --from-literal=VlTesteAmbiente='Teste utilizando secret from-literal no Kubernetes | Azure na Prática' -n "anp-teste03"
